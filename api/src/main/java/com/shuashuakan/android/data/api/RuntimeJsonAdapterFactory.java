...
/**
 * See https://github.com/square/moshi/pull/264
 */
public final class RuntimeJsonAdapterFactory implements JsonAdapter.Factory {
  ...
  private static final class RuntimeJsonAdapter extends JsonAdapter<Object> {
    ...
    @Override public Object fromJson(@NonNull JsonReader reader) throws IOException {
      ...
      JsonAdapter<?> delegate = labelToDelegate.get(String.valueOf(label));
      if (delegate == null) {
        return null;
      }
    ...
    @Override public void toJson(@NonNull JsonWriter writer, Object value) throws IOException {
