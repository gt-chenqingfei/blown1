...
public class DZStickyNavLayouts extends LinearLayout implements NestedScrollingParent {
    ...
    public DZStickyNavLayouts(Context context, AttributeSet attrs) {
        ...
        mHeaderView.setBackgroundColor(ContextCompat.getColor(context,R.color.colorPrimary));
        mFooterView = new AnimatorView(context);
        mFooterView.setBackgroundColor(ContextCompat.getColor(context,R.color.colorPrimary));
    ...
    public void setFootLayoutViewShow(){
        mFooterView.setFootLayoutShow();
        invalidate();
    }
    public void setFootLayoutViewHide(){
        mFooterView.setFootLayoutHide();
        invalidate();
    }
