...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
  ...
  public IconPageIndicator(Context context, AttributeSet attrs) {
    ...
    mIconsLayout = new LinearLayout(context, null, R.attr.vpiIconPageIndicatorStyle);
  ...
  @Override public void setViewPager(ViewPager view) {
    ...
    if (adapter == null) {
      throw new IllegalStateException("ViewPager does not have feedAdapter instance.");
    }
    mViewPager = view;
  ...
  @Override public void notifyDataSetChanged() {
    ...
    for (int i = 0; i < count; i++) {
      ...
      //TODO the margin should define as style
