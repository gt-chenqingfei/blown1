...
public class SectionProgressBar extends View {
    ...
    private void init(Context paramContext) {
        ...
        mFirstPointPaint.setColor(ContextCompat.getColor(paramContext,R.color.transparent));

        mBreakPointPaint.setStyle(Paint.Style.FILL);
        mBreakPointPaint.setColor(ContextCompat.getColor(paramContext,R.color.black));
    ...
    public synchronized int getCount() {
        return mBreakPointInfoList.size();
    }
