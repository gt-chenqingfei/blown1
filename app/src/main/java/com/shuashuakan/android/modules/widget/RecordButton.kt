...
class RecordButton @JvmOverloads constructor(mContext: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(mContext, attrs, defStyleAttr) {
  ...
  private fun init() {
    ...
    mMaxRectWidth = context.dip(28f).toFloat()
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    val backGradient = LinearGradient(0f, 0f, width.toFloat(), height.toFloat(),
        context.getColor1(R.color.color_ffef30), context.getColor1(R.color.color_normal_59ff5a), Shader.TileMode.CLAMP)
    ...
    canvas.drawRoundRect(mRectF, context.dip(4f).toFloat(), context.dip(4f).toFloat(), mRectPaint)
  }
