...
import com.shuashuakan.android.data.api.model.home.multitypetimeline.UserLeaderBoard
 ...
 */
class MuliTypeChainUserLeaderBoardViewHolder(
        val apiService: ApiService,
        val compositeDisposable: CompositeDisposable,
        val mContext: Context,
        val helper: BaseViewHolder,
        private val userModel: UserLeaderBoard) {
