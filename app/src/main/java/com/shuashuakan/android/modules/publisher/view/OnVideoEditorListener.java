...
public interface OnVideoEditorListener {
    ...
    /**
     * This is a callback when user adds any view on the it can be
    ...
    /**
     * This is a callback when user remove any view on the it happens when usually
     * undo and redo happens or text is removed
     *
     * @param numberOfAddedViews number of views currently added
     * @deprecated Use {@link OnVideoEditorListener#onRemoveViewListener(ViewType, int)} instead
     */
    @Deprecated
