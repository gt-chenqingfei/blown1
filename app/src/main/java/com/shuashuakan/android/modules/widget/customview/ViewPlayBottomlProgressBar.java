 ...
 */
public class ViewPlayBottomlProgressBar extends LinearLayout {

    private Context context;

    public ViewPlayBottomlProgressBar(Context context) {
        super(context);
        init(context);
    }

    public ViewPlayBottomlProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
