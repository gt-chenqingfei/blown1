...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public String compressSavePath=Environment.getExternalStorageDirectory() + "/com.shuashuakan.android";
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isUploadVideo ? (byte) 1: (byte) 0);
    ...
    protected PictureSelectionConfig(Parcel in) {
        ...
        this.isUploadVideo = in.readByte() !=0;
