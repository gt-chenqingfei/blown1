...
public class CircleProgressView extends ProgressBar {
    ...
    private int mNormalBarSize = dp2px(getContext(), 2); // 未完成进度条大小
    private int mReachBarSize = dp2px(getContext(), 2); // 未完成进度条大小
    ...
    private int mOuterSize = dp2px(getContext(), 1); // 外层圆环宽度
