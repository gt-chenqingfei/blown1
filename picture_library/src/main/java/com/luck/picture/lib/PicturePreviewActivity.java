...
public class PicturePreviewActivity extends PictureBaseActivity implements
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    rightTv.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if(viewPager.getCurrentItem()<0 || viewPager.getCurrentItem()>=images.size()){
          return ;
        }
        ...
        if (selectImages.size() != 0 && !selectImages.get(0).getPath().equals(imageSel.getPath())) {
          Toast.makeText(mContext, getResources().getString(R.string.string_can_choose_only), Toast.LENGTH_SHORT).show();
        } else {
          detailSelect();
        }
      }
    ...
    if (images.size() != 0) {
      ...
      scaleVideo(images.get(0).getPath(), new VideoCompressListener() {
        ...
        public void onFailed(String errorMsg) {
          Toast.makeText(PicturePreviewActivity.this, getResources().getString(R.string.string_video_compress_error), Toast.LENGTH_SHORT).show();
        }
      });
    }
  ...
  private void scaleVideo(String filePath, final VideoCompressListener listener) {
    ...
    String VIDEO_STORAGE_DIR = new File(getExternalCacheDir(), "ugc").getAbsolutePath();
    ...
    String dstFilePath = new File(VIDEO_STORAGE_DIR, "format_" + System.currentTimeMillis() + ".mp4").getAbsolutePath();
