...
public class TraceableFrameLayout extends FrameLayout implements TraceableView {
  private ViewProxy viewProxy = ViewProxy.NONE;

  public TraceableFrameLayout(Context context) {
    super(context);
  }

  public TraceableFrameLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public TraceableFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
