...
public class TraceableRelativeLayout extends RelativeLayout implements TraceableView {
  private ViewProxy viewProxy = ViewProxy.NONE;

  public TraceableRelativeLayout(Context context) {
    super(context);
  }

  public TraceableRelativeLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public TraceableRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
