...
public class TraceableSimpleDraweeView extends SimpleDraweeView implements TraceableView {
  private ViewProxy viewProxy = ViewProxy.NONE;

  public TraceableSimpleDraweeView(Context context) {
    super(context);
  }

  public TraceableSimpleDraweeView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public TraceableSimpleDraweeView(Context context, AttributeSet attrs, int defStyleAttr) {
