...
public class TraceableCheckedTextView extends AppCompatCheckedTextView implements TraceableView {
  private ViewProxy viewProxy = ViewProxy.NONE;

  public TraceableCheckedTextView(Context context) {
    super(context);
  }

  public TraceableCheckedTextView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public TraceableCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
