...
public class CropImageView extends FrameLayout {
    ...
    public void setNeedCircleFrame(boolean isNeedCircleFrame) {
        ...
        if (mCropOverlayView != null) {
            mCropOverlayView.setNeedCircleFrame(isNeedCircleFrame);
        }
    }
    ...
    public Bitmap getCroppedImage() {
        ...
        final Bitmap croppedBitmap = Bitmap.createBitmap(mBitmap, (int) actualCropX,
                (int) actualCropY, (int) actualCropWidth, (int) actualCropHeight);
    ...
    public RectF getActualCropRect() {
        ...
        final RectF actualCropRect = new RectF(actualCropLeft, actualCropTop, actualCropRight,
                actualCropBottom);
